...
def get_specific_tickers(tickers):
    # Récupère les informations sur les tickers spécifiés de la meme manière que get_tickers
    try:
        load_dotenv()
        MONGO_URI = os.getenv("MONGO_URI")
        DB_NAME = os.getenv("DB_NAME_STOCKS")
        ...
        print(f"Erreur dans get_specific_tickers: {e}")
        return []