...
def create_tradingview_button(data_overview):
    ...
    try:    
        ...
        return html.Div([
            dbc.Button("Voir sur TradingView", color="primary", href=link, target="_blank", style={"width": "100%"})
        ])
    except Exception as e:
        return dbc.Button("Ouvrir TradingView", color="primary", href="https://www.tradingview.com/", target="_blank")